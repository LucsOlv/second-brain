# 🧠 Second Brain — Lucas Oliveira

> Um vault Obsidian para organizar sua vida, projetos e conhecimento.
...
- **GitHub**: backup do vault (commits manuais via Git)
- **Syncthing**: sync cross-device em tempo real

## 📌 Regra de Ouro

> Everything is interconnected. Use `[[links]]` liberally — o Graph View é seu melhor amigo.